...
def upload():
    if request.method == 'POST':
        ...
        if f:
            ...
            #     instructions="You are an expert Document Analyst. Use you knowledge base to answer questions from Documents.",
            #     model="gpt-4o-mini",
            ...
            file_batch = client.beta.vector_stores.file_batches.upload_and_poll(
                vector_store_id='vs_wezGDuGGSoz0cKgXxh0DHPG6', files=file_streams
            )
